...
def test_security_integration():
    ...
    with connection.cursor() as cursor:
        ...
        fields = [
            f
            for f in ["failed_login_attempts", "lockout_until", "last_failed_login"]
            if f in all_fields
        ]
...
def test_notification_settings():
    ...
    notif_settings = {
        "APPROVAL_EMAIL_NOTIFICATIONS": get_setting(
            "APPROVAL_EMAIL_NOTIFICATIONS", True
        ),
        "APPROVAL_ESCALATION_EMAIL_NOTIFICATIONS": get_setting(
            "APPROVAL_ESCALATION_EMAIL_NOTIFICATIONS", True
        ),
        "SLA_BREACH_EMAIL_NOTIFICATIONS": get_setting(
            "SLA_BREACH_EMAIL_NOTIFICATIONS", True
        ),
