...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "database_file",
                    models.FileField(
                        blank=True, null=True, upload_to="backups/database/"
                    ),
                ),
                (
                    "media_archive",
                    models.FileField(blank=True, null=True, upload_to="backups/media/"),
                ),
                (
                    "settings_file",
                    models.FileField(
                        blank=True, null=True, upload_to="backups/settings/"
                    ),
                ),
                (
                    "file_size_bytes",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="system_maintenance.backuprecord",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["-created_at"], name="system_main_created_b2e4e6_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="backuprecord",
        ...
        migrations.AddIndex(
            model_name="backuprecord",
            index=models.Index(
                fields=["backup_type"], name="system_main_backup__11a6b7_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="systemhealthcheck",
            index=models.Index(
                fields=["-performed_at"], name="system_main_perform_e6f544_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="systemhealthcheck",
            index=models.Index(
                fields=["overall_status"], name="system_main_overall_fd128f_idx"
            ),
        ),
    ]
