...
def view_activity_logs(request):
    ...
    all_content_types = ActivityLog.objects.values_list(
        'content_type', flat=True
    ).distinct().exclude(content_type='')
...
def export_logs(request):
    ...
    if export_format == 'json':
        ...
        writer.writerow([
            'ID', 'Timestamp', 'User', 'Email', 'Action', 'Content Type',
            'Object ID', 'Object', 'Description', 'IP Address', 'Device',
            'Location', 'Success', 'Error Message'
        ])
