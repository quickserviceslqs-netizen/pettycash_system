...
urlpatterns = [
    ...
    path('treasury/fund/<uuid:fund_id>/', views.treasury_fund_detail, name='treasury-fund-detail'),
    path('treasury/fund/<uuid:fund_id>/export/ledger.csv', views.treasury_fund_ledger_export_csv, name='treasury-fund-ledger-export-csv'),
    path('treasury/fund/<uuid:fund_id>/export/ledger.xlsx', views.treasury_fund_ledger_export_xlsx, name='treasury-fund-ledger-export-xlsx'),
    path('treasury/fund/<uuid:fund_id>/export/payments.csv', views.treasury_fund_payments_export_csv, name='treasury-fund-payments-export-csv'),
    path('treasury/fund/<uuid:fund_id>/export/payments.xlsx', views.treasury_fund_payments_export_xlsx, name='treasury-fund-payments-export-xlsx'),
