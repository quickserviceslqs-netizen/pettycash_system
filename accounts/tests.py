...
class Phase4LoginTests(TestCase):
    def setUp(self):
        ...
        self.staff = User.objects.create_user(username='staff', password='pass123', role='STAFF')
        self.finance = User.objects.create_user(username='finance', password='pass123', role='FINANCE')
        self.treasury = User.objects.create_user(username='treasury', password='pass123', role='TREASURY')
