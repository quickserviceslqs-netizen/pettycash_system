...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.OneToOneField(
                        ...
                        related_name="treasury_dashboard",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="alerts",
                        to="treasury.varianceadjustment",
                    ),
                ),
                (
                    "resolved_by",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["dashboard", "metric_type", "metric_date"],
                name="treasury_da_dashboa_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="dashboardmetric",
            index=models.Index(
                fields=["metric_type", "metric_date"], name="treasury_da_metric__idx"
            ),
        ),
        migrations.AddIndex(
            model_name="alert",
            index=models.Index(
                fields=["alert_type", "severity", "created_at"],
                name="treasury_al_alert_t_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="alert",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["fund", "forecast_date"], name="treasury_fu_fund_id_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="fundforecast",
            index=models.Index(
                fields=["needs_replenishment", "forecast_date"],
                name="treasury_fu_needs_r_idx",
            ),
        ),
    ]
